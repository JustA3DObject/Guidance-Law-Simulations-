...
psi0 = deg2rad(45); % Initial heading (rad)
...
initial_a = 5;      % Constant acceleration for the initial phase (m/s^2)
...
% Higher speed leads to a larger 'n', resulting in a steeper, more "zoned" deceleration profile.
% Slower speed leads to a smaller 'n', resulting in a gradual, single-zone profile.
n_min = 2;
n_max = 5;
